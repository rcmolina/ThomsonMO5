...
#define WAVE_FORMAT_SAMPLESPERSEC  4000	   	   // antes 44100
...
{
    write_gap (WAVE_FORMAT_SAMPLESPERSEC*2, file); // entre 2
}
...
static void update_wav_header (char *filename)
{
    ...
    if (file != NULL)
    {
        ...
        write_le4 (WAVE_FORMAT_SAMPLESPERSEC, file); //multiplica *2
